...
<div style="position: absolute;top: 5px;right: 20px" ><font color="ffffff">欢迎您：&nbsp;<%=platform.getPlatformname() %>|<a target="mainAction" href="updateMima.jsp"></a>|<a target="_top" onclick="loginout()" href="logininput.jsp">退出</a></font></div>
</div>
</body>
</html>