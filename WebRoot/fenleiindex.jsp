...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
 ...
 <div onclick="select1()" class="layui-progress-bar layui-bg-red" lay-percent="0%"></div>
</div>
...
function select1()
{
	window.location.href("fenlei.jsp?platformtech=重点实验室");
}

function select2()
{
	window.location.href("fenlei.jsp?platformtech=工程技术研究中心");
}
function select3()
{
	window.location.href("fenlei.jsp?platformtech=产业技术研究院");
}
</script>
</body>
</html>